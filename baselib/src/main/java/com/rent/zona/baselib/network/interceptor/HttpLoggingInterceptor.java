    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !hasRequestBody) {
                ...
                if (!isTextBody(request.header("Content-Type"))) {
                    logger.log("--> END " + request.method() + " (not text body)");
                } else {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !hasBody) {
                ...
                if (!isTextBody(response.header("Content-Type"))) {
                    logger.log("<-- END HTTP (not text body)");
                } else {
