...
public class HelperActivity extends AppCompatActivity {
    ...
    private void showRequestPermissionRationale() {
        Snackbar snackbar = Snackbar.make(
                view,
                getString(R.string.album_permission_info),
                Snackbar.LENGTH_INDEFINITE)
                .setAction(getString(R.string.album_ok), new View.OnClickListener() {
                    @Override
    ...
    private void showAppPermissionSettings() {
        Snackbar snackbar = Snackbar.make(
                view,
                getString(R.string.album_permission_force),
                Snackbar.LENGTH_INDEFINITE)
                .setAction(getString(R.string.album_permission_settings), new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Uri uri = Uri.fromParts(
                                getString(R.string.album_permission_package),
