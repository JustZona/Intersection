...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.album_image_view);
        }
        ...
        Constants.limit = intent.getIntExtra(Constants.INTENT_EXTRA_LIMIT, Constants.limit);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                actionMode.setTitle(countSelected + " " + getString(R.string.album_selected));

                if (countSelected == 0) {
                    actionMode.finish();
                }
                if(countSelected==1 && Constants.limit==1){
                    sendIntent();
                }
            }
        });
    ...
    private ActionMode.Callback callback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            menuInflater.inflate(R.menu.album_menu_contextual_action_bar, menu);
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.limit) {
            Toast.makeText(
                    ...
                    String.format(getString(R.string.album_limit_exceeded), Constants.limit),
                    Toast.LENGTH_SHORT)
                    .show();
            return;
        }
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            Cursor cursor = getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection,
                    TextUtils.isEmpty(album)?null:(MediaStore.Images.Media.BUCKET_DISPLAY_NAME + " =?"), TextUtils.isEmpty(album)?null:new String[]{ album }, MediaStore.Images.Media.DATE_ADDED);
