...
public class CustomImageSelectAdapter extends CustomGenericAdapter<Image> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.album_grid_view_item_image_select, null);
        ...
        Glide.with(context)
                ...
                .apply(new RequestOptions().placeholderOf(R.drawable.album_image_placeholder))
