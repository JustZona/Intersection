...
* @date 2018/4/23 0023
*/
public abstract class PullToRefreshBaseActivity<D> extends BaseActivity implements CommonHandler.MessageHandler, WebErrorView.WebErrorViewClickListener
        ,OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getCusContentView()!=-1){
            ViewGroup contentView = (ViewGroup) findViewById(R.id.content_root);
            if(contentView!=null){
                contentView.addView(View.inflate(this,getCusContentView(),null),0);
            }
        }
                ...
                public void run() {
                    ...
                    if (cacheContent != null) {
                        D cacheData = GsonFactory.getDefault().
                                fromJson(cacheContent, getCacheDataType());
                        if (cacheData != null) {
...
//        }
    ...
    protected Type getCacheDataType(){
        return new TypeToken<D>(){}.getType();
    };
}
