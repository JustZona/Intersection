...
public abstract class RefreshRecycleViewActivity<D>  extends BaseActivity implements CommonHandler.MessageHandler,OnRefreshListener,OnLoadMoreListener, WebErrorView.WebErrorViewClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentRoot= (ViewGroup) findViewById(R.id.content_root);
        mContentRv= (EmptyRecyclerView) findViewById(R.id.content_rv);
        mEmptyView= (CommonEmptyView) findViewById(R.id.empty);
        ...
        ensureList();
        setListAdapter(onCreateAdapter(this));
        if (mContentRv != null) {
...
//            setPageKey(listDto);
        ...
        if(listDto.pageIndex==0)
        setListShown(true);
        onLoadFinished(false);
        mSmartRefreshLayout.setNoMoreData(listDto!=null?listDto.hasNoMore():true);
    }
...
//        mSmartRefreshLayout.setNoMoreData(false);
        ...
        if (mEmptyView != null && mAdapter.isDataEmpty()) {
            ...
            ActivityUIHelper.showFailure(throwable, this);
        }
    }
