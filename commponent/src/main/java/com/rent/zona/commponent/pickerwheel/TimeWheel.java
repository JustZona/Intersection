...
import com.rent.zona.commponent.pickerwheel.adapters.NumericWheelAdapter;
import com.rent.zona.commponent.pickerwheel.config.PickerConfig;
import com.rent.zona.commponent.pickerwheel.data.source.TimeRepository;
import com.rent.zona.commponent.pickerwheel.utils.PickerConstants;
import com.rent.zona.commponent.pickerwheel.utils.Utils;
...
public class TimeWheel {
    ...
    void initYear() {
        ...
        mYearAdapter = new NumericWheelAdapter(mContext, minYear, maxYear, PickerConstants.FORMAT, PickerConstants.YEAR);
    ...
    void updateMonths() {
        ...
        mMonthAdapter = new NumericWheelAdapter(mContext, minMonth, maxMonth, PickerConstants.FORMAT, PickerConstants.MONTH);
    ...
    void updateDays() {
        ...
        int minDay = mRepository.getMinDay(curYear, curMonth);
        mDayAdapter = new NumericWheelAdapter(mContext, minDay, maxDay, PickerConstants.FORMAT, PickerConstants.DAY);
    ...
    void updateHours() {
        ...
        mHourAdapter = new NumericWheelAdapter(mContext, minHour, maxHour, PickerConstants.FORMAT, PickerConstants.HOUR);
    ...
    void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(mContext, minMinute, maxMinute, PickerConstants.FORMAT, PickerConstants.MINUTE);
