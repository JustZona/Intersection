...
public class AutoSizeHeightImageView extends ImageView {
    ...
    public AutoSizeHeightImageView(Context context) {
        this(context, null);
    }

    public AutoSizeHeightImageView(Context context, AttributeSet attr) {
        super(context, attr);
    }
