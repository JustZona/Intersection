...
public class CompletedView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.CompletedView_radius, 80);
        mStrokeWidth = typeArray.getDimension(R.styleable.CompletedView_strokeWidth, 10);
        ...
        textColor=typeArray.getColor(R.styleable.CompletedView_ringTextColor, 0xFF333333);
        textSize=typeArray.getDimensionPixelSize(R.styleable.CompletedView_ringTextSize, DensityUtils.dip2px(getContext(),15));
        textUnit=typeArray.getString(R.styleable.CompletedView_textUnit);
        if(TextUtils.isEmpty(textUnit)){
            textUnit="";
        }
        mProgress=typeArray.getInt(R.styleable.CompletedView_curProgress,0);
    }
...
//            String txt = mProgress + "分";
            String txt = getShowProgress() + textUnit;
    ...
    private String getShowProgress(){
        if(mProgress>=10000){
            return new DecimalFormat("#.#").format(mProgress/10000f);
        }else{
            return mProgress+"";
        }
    }
